...
User Function QQRPCP02()
	Local lRet				:= .T.
	Local aDadosCab			:= {}   
	Local cObjParambox		:= "ParamQQRPCP02"
...
Static Function createQuery(oParamBox)
	...
	MemoWrite("\sql\QQRPCP02_getQryReport.sql",cQuery)
...
Static Function gerarReport(aDadosCab, oParamBox)
	...
	oExcelXML:SetOrigem("\xmls\QQRPCP02.xml")						//Indica o caminho do arquivo Origem (que será aberto e clonado)
	oExcelXML:SetDestino(GetTempPath() + "RESULT_QQRPCP02.xml")				//Indica o caminho do arquivo Destino (que será gerado)
	//oExcelXML:SetDestino("T:\totvs\teste\protheus12_data\xmls\RESULT_QQRPCP02.xml")				//Indica o caminho do arquivo Destino (que será gerado)
